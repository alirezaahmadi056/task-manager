package ir.lrn.kara.ui.graph.duties.task
...
import ir.lrn.kara.data.db.task.Task
import ir.lrn.kara.data.db.task.TaskItem
import ir.lrn.kara.data.db.task.TaskItemType
import ir.lrn.kara.navigation.Screen
import ir.lrn.kara.ui.component.DialogDeleteItemTask
import ir.lrn.kara.ui.component.EmptyList
import ir.lrn.kara.ui.component.MySnackbarHost
import ir.lrn.kara.ui.component.PageType
import ir.lrn.kara.ui.component.SelectedSortNotList
import ir.lrn.kara.ui.component.SwipeToDismissBoxLayout
import ir.lrn.kara.ui.graph.duties.task.addTask.FastNoteSection
import ir.lrn.kara.util.Constants
import ir.lrn.kara.util.TaskHelper
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                onClick = {
                    ...
                    navHostController.navigate(Screen.AddTaskScreen(lastId =lastId))
                }
            )
        },
                ...
                items(fastTaskInCompleted, key = { it.id }) { task ->
                    SwipeToDismissBoxLayout(
                        ...
                        startToEnd = {
                            if (!hasNavigated) {
                                hasNavigated = true
                                navHostController.navigate(Screen.AddTaskScreen(id =task.id ))
                            }
                        },
                        endToStart = {
                ...
                items(incompleteTasks, key = { task -> task.id }) { taskItem ->
                    SwipeToDismissBoxLayout(
                        ...
                        startToEnd = {
                            if (!hasNavigated) {
                                hasNavigated = true
                                navHostController.navigate(Screen.AddTaskScreen(id=taskItem.id))
                            }
                        },
                        endToStart = {
                        ...
                        TaskItemCard(
                            item = taskItem,
                            onClick = { navHostController.navigate(Screen.AddTaskScreen(id = taskItem.id)) },
                            onLogClick = {
                                singleDeleteTask = taskItem
                                showDialogDelete = true
                            }
