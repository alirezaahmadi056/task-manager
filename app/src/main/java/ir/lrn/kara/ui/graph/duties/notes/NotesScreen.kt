package ir.lrn.kara.ui.graph.duties.notes
...
import ir.lrn.kara.ui.graph.duties.notes.addNotes.FastNoteSection
    ...
    Scaffold(
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                onClick = { navHostController.navigate(Screen.AddNotesScreen(null)) })
                    ...
                    items(sortedNotesItem, key = { it.id }) { notesItem ->
                        SwipeToDismissBoxLayout(
                            ...
                            startToEnd = {
                                if (!hasNavigated) {
                                    hasNavigated = true
                                    navHostController.navigate(Screen.AddNotesScreen(id=notesItem.id))
                                }
                            },
                            endToStart = {
                ...
                LazyColumn(
                    ...
                    items(items = sortedNotesItem, key = {it.id}) { notesItem ->
                        SwipeToDismissBoxLayout(
                            ...
                            NotesListItem(
                                item = notesItem,
                                onClick = { navHostController.navigate(Screen.AddNotesScreen(id=notesItem.id)) },
                                onLogClick = {
                                    singleDeleteNotes = notesItem
                                    showDialogDelete = true
                                }
