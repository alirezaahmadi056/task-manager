...
import ir.lrn.kara.ui.graph.duties.notes.NotesListItem
import ir.lrn.kara.ui.graph.duties.task.TaskItemCard
            ...
            if (filteredNotes.isNotEmpty()) {
                ...
                items(filteredNotes) { note ->
                    NotesListItem(item = note, onClick = {
                        navHostController.navigate(Screen.AddNotesScreen(id = note.id))
                    })
                }
            }
